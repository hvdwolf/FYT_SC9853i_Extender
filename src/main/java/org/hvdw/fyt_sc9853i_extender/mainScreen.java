...
import org.hvdw.fyt_sc9853i_extender.controllers.TabBackupRestore;
...
public class mainScreen {
    ...
    private TabBackupRestore TabBRFunctions = new TabBackupRestore();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        btn_restore_boot_image.setEnabled(true);
        ...
        btn_restore_recovery_image.setEnabled(true);
...
/*        menuItem = new JMenuItem("Check for new version");
    ...
    private mainScreen(JFrame frame) {
        ...
        btn_restore_boot_image.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                // Button that will write a boot image to the partition

                TabBRFunctions.WriteImage(rootPanel, "boot");
            }
        });

        btn_restore_recovery_image.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
                // Button that will write a boot image to the partition

                TabBRFunctions.WriteImage(rootPanel, "recovery");
            }
        });
